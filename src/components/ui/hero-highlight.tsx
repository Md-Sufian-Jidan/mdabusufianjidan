...
export const HeroHighlight = ({
  ...
  const dotPatterns = {
    light: {
      ...
      hover: `url("data:image/svg+xml;charset=utf-8,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 32 32' width='16' height='16' fill='none'%3E%3Ccircle fill='%2315803d' id='pattern-circle' cx='10' cy='10' r='2.5'%3E%3C/circle%3E%3C/svg%3E")`,
    },
    dark: {
...
export const Highlight = ({ children, className }: { children: React.ReactNode; className?: string; }) => {
  return (
    <motion.span
      ...
      className={cn(
        `relative inline-block rounded-lg bg-gradient-to-r from-primary to-primary/80 px-2 pb-1`,
        className
      )}
    >
      {children}
