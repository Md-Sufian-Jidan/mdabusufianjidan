...
export default function About() {
    ...
    return (
        ...
        >
            ...
            <div className="absolute top-1/2 left-0 w-[500px] h-[500px] bg-primary/5 rounded-full blur-[120px] -translate-x-1/2 -translate-y-1/2 pointer-events-none bg-drift" />
            <div className="absolute top-0 right-0 w-[400px] h-[400px] bg-primary/10 rounded-full blur-[100px] translate-x-1/3 -translate-y-1/3 pointer-events-none about-float" />
            ...
            <div className="container relative z-10 mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="grid lg:grid-cols-12 gap-12 lg:gap-20 items-center">
                    ...
                    <div className="lg:col-span-5 relative group" ref={imageContainerRef}>
                        <div className="relative aspect-[3/4] sm:aspect-square lg:aspect-[4/5] rounded-[2.5rem] lg:rounded-[3rem] overflow-hidden border border-white/10 shadow-2xl about-card-glow about-image-reveal">
                            ...
                            <img
                                ...
                                className="w-full h-full object-cover scale-105 group-hover:scale-100 grayscale-[0.8] group-hover:grayscale-0 transition-all duration-1000 ease-out"
                            />
                            ...
                            <div className="absolute bottom-6 sm:bottom-8 left-6 sm:left-8 right-6 sm:right-8 p-4 sm:p-6 glass rounded-2xl border-white/10 z-20 translate-y-4 opacity-0 group-hover:translate-y-0 group-hover:opacity-100 transition-all duration-500 delay-100">
                                <p className="text-foreground font-serif text-lg sm:text-xl font-bold italic leading-snug">"Code is the foundation; Design is the facade."</p>
                            </div>
                        </div>

                        {/* Floating Interaction Elements */}
                        <div className="about-float absolute -top-8 -right-4 sm:-right-8 w-28 h-28 sm:w-32 sm:h-32 glass rounded-2xl sm:rounded-3xl flex flex-col items-center justify-center border-primary/20 shadow-2xl z-30 about-card-glow backdrop-blur-xl">
                        ...
                        <div className="about-float absolute -bottom-6 -left-4 sm:-left-6 p-4 glass rounded-2xl border-primary/10 shadow-xl z-30 backdrop-blur-xl hidden sm:flex items-center gap-3">
                    ...
                    <div className="lg:col-span-7 space-y-8 sm:space-y-10 relative" ref={contentRef}>
                        ...
                        >
                            ...
                            <div className="mt-6 sm:mt-8 space-y-5 font-inter text-muted-foreground text-base sm:text-lg leading-relaxed">
                                ...
                                <p>
                                    Currently refining digital landscapes at SM Technology, I specialize in building responsive systems that don't just work—they perform flawlessly and scale effortlessly.
                                </p>
                            </div>
                        </motion.div>

                        <Separator className="bg-primary/10 w-full sm:w-3/4" />
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
                            ...
                            <DetailItem icon={<User size={18} />} label="Focus" value="Full Stack Architecture" delay={0.4} />
                        </div>
                        ...
                        >
                            <button className="w-full sm:w-auto px-8 py-4 bg-primary text-primary-foreground rounded-full font-bold flex items-center justify-center gap-3 transition-all active:scale-95 about-btn-glow relative overflow-hidden group">
...
function DetailItem({ icon, label, value, delay }: { icon: React.ReactNode, label: string, value: string, delay: number }) {
    return (
        <motion.div
            ...
            viewport={{ once: true }}
            className="flex items-start gap-4 p-4 rounded-2xl glass border border-white/5 hover:border-primary/20 hover:bg-primary/[0.02] transition-all group cursor-default"
        >
